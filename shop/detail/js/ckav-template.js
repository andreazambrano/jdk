...
***************************************************************
* AUTHOR : CKavArt
* PROJECT : Ira One Page Creative HTML Template
...
; (function () {
	...
	********************************************/
	...
	//$("#config_style").attr('href', 'css/configstyle.css?' + ckav.uid());
			...
			********************************************/
			if ($o.gmapwidget) {
				var social_script_arr = [
					"//maps.google.com/maps/api/js?key=AIzaSyAgKruCtYTWOHtxI4PT6iQoUgEbyTkp0Uc&sensor=false&libraries=geometry,places&v=3.7",
